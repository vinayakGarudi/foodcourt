  ...
  return (
    <>
       ...
       <Navbar bg="light" variant="dark"
        sticky="top" className="navbar bg-sm-dark"
        expand="sm" collapseOnSelect                                 // coment to add side bar
        > 
        ...
        <Navbar.Collapse>                      
          ...
          <Nav.Link  className="links"href="#home">Home</Nav.Link>
            <Nav.Link className="links" href="#bestdeal">Best Deals</Nav.Link>
            <Nav.Link  className="links"href="#oursponsors">Our Sponors</Nav.Link>
            <Nav.Link  className="links"href="#contactus">Contact Us</Nav.Link>
            <Nav.Link  className="links"id="signup" href="#signup">Sign up</Nav.Link>
